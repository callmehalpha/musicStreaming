...
import '../models/listsongtitle1_item_model.dart';
import 'package:flutter/material.dart';
import 'package:init_s_application4/core/app_export.dart';

// ignore: must_be_immutable
class Listsongtitle1ItemWidget extends StatelessWidget {
  Listsongtitle1ItemWidget(this.listsongtitle1ItemModelObj);

  Listsongtitle1ItemModel listsongtitle1ItemModelObj;

  var controller = Get.find<LightAlbumDetailsController>();
