import '../search_result_album_screen/widgets/gridloremipsumdol_item_widget.dart';
...
class SearchResultAlbumScreen extends GetWidget<SearchResultAlbumController> {
  @override
                      ...
                      Padding(
                        ...
                        child: Obx(
                          () => GridView.builder(
                            ...
                            itemCount: controller.searchResultAlbumModelObj
                                .value.gridloremipsumdolItemList.length,
                            itemBuilder: (context, index) {
                              GridloremipsumdolItemModel model = controller
                                  .searchResultAlbumModelObj
                                  .value
                                  .gridloremipsumdolItemList[index];
