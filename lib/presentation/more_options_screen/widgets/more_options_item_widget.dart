...
import '../models/more_options_item_model.dart';
import 'package:flutter/material.dart';
import 'package:init_s_application4/core/app_export.dart';

// ignore: must_be_immutable
class MoreOptionsItemWidget extends StatelessWidget {
  MoreOptionsItemWidget(this.moreOptionsItemModelObj);

  MoreOptionsItemModel moreOptionsItemModelObj;

  var controller = Get.find<MoreOptionsController>();
